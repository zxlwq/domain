import { Domain, DomainsResponse, NotificationSettingsResponse, WebDAVConfig, WebDAVResponse } from './types';
...
export async function saveNotificationSettingsToServer(settings: any): Promise<NotificationSettingsResponse> {
  const normalized = {
    ...settings,
