            ...
            <div className="settings-section">
              ...
              <div className="form-group">
                ...
                <div className="checkbox-group notification-methods">
                  ...
                  <label className="notification-method wxpush-method">
                    <input
                      id="notification-wxpush"
                      type="checkbox"
                      checked={form.notificationMethods.includes('wxpush')}
                      onChange={e => handleNotificationMethodChange('wxpush', e.target.checked)}
                      disabled={form.notificationEnabled !== 'true'}
                    />
                    <span>🔔 Wxpush</span>
                  </label>
